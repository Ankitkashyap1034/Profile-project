...
<body>
  <div class="container-xl px-4 mt-4">
    <nav class="nav nav-borders">
      ...
      <a class="nav-link" href="security.php?msz=ok">Security</a>
      ...
      <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
            ...
            <div class="card mb-4 mb-xl-0">
              <div class="card-header">Profile Picture</div>
                <div class="card-body text-center">
                  ...
                  <input class="form-control mb-3" type="file" name="profile_photo" required>
            ...
            <div class="card mb-4 mb-xl-0 mt-4">
              <div class="card-header">Cover Picture</div>
                <div class="card-body text-center">
                  ...
                  <input class="form-control mb-3" type="file" name="cover_photo" required>
                  <!-- <button class="btn btn-primary" type="button">Upload new image</button> -->
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              ...
              <div class="row gx-3 mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input class="form-control" id="inputEmailAddress" type="text" placeholder="Something about Yourself" name="about" value="" required>
                </div>

                <div class="row gx-3 mb-3">
                  <div class="col-md-6">
                    <label class="small mb-1" for="inputOrgName">Website</label>
                    <input class="form-control" id="inputOrgName" type="text" placeholder="Have any Website? Give your website link" value="" name="website" required>
                  </div>
                ...
                <div class="row gx-3 mb-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <input class="form-control" id="inputBirthday" type="date" name="dob" placeholder="06/10/1988" value="" required>
                  </div>

                  <div class="mb-3">
                    <label class="small mb-1" for="inputEmailAddress">Age</label>
                    <input class="form-control" id="inputEmailAddress" type="number" placeholder="Your age" value="" name="age" required>
                  </div>

                  <div class="mb-3">
                    <label class="small mb-1" for="inputEmailAddress">Profession</label>
                    <input class="form-control" id="inputEmailAddress" type="text" placeholder="Your Profession" value="" name="profession" required>
                  </div>

                  <div class="mb-3">
                    <label class="small mb-1" for="inputEmailAddress">About Profession</label>
                    <input class="form-control" id="inputEmailAddress" type="text" placeholder="Say something about your Profession" value="" name="about_profession" required>
                  </div>
                </div>
          ...
          <?php
            ...
            if(isset($_POST['submit'])){
              ...
              $insert = mysqli_query($conn,"INSERT INTO user (profile_pic_name,cover_photo_name,name,about,profession,about_profession,dob,age,email,location,website,phone) VALUES ('$profile_pic_name','$cover_photo_name','$name','$about','$profession','$about_profession','$dob','$age','$email_change','$location','$website ','$phone')");
              ...
              if($insert){
                ...
                echo "<meta http-equiv='refresh' content='0;URL=profile_edit.php'>";
              }
            }
          ?>
        </div>
